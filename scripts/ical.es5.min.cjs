                ...
                },
                {
                    ...
                    value: function (t, n, r, i, a) {
                        ...
                        if (
                            ...
                            for (
                                ;
                                !(c <= (f = e.daysInMonth(m.month, m.year)));
        ...
        (E._handleContentLine = function (t, e) {
            ...
            e.designSet.propertyGroups && -1 !== i.indexOf(".")
                ...
                y in e.designSet.property &&
                    ("multiValue" in (f = e.designSet.property[y]) &&
                        (p = f.multiValue),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                (r += e.EXTRA_COVERAGE),
                                !this.changes.length ||
                                    this.expandedUntilYear < t)
                            ) {
                                for (
                                    var i =
                                            this.component.getAllSubcomponents(),
                                        a = i.length,
                                        s = 0;
                                    s < a;
                                    s++
            ...
            return o(
                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            for (
                                var t = this.toSeconds(), e = this.factor;
                                t < -43200;
                    ...
                    [
                        {
                            ...
                            value: function (t, e) {
                                ...
                                var i = t.split("T"),
                                    ...
                                    s = i[1],
                                    o = s
                                        ? It.vcard.value.time._splitZone(s)
                                        : [],
                                    u = o[0],
                                    l = o[1],
                                    h = a ? a.length : 0,
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if ("YEARLY" == this.rule.freq) {
                            for (
                                var a = this.rule.until
                                    ? this.rule.until.year
                                    : 2e4;
                                this.last.year <= a &&
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        if ("BYMONTH" in n && "BYWEEKNO" in n) {
                            ...
                            for (
                                var f = 0;
                                f < this.by_data.BYWEEKNO.length && s;
                                f++
                            ) {
            ...
            time: {
                ...
                toICAL: function (t) {
                    ...
                    return (
                        8 == r.length
                            ? (r =
                                  r.slice(0, 2) + r.slice(3, 5) + r.slice(6, 8))
                            : 5 == r.length && "-" != r[0]
                              ? (r = r.slice(0, 2) + r.slice(3, 5))
                              : 6 == r.length &&
                                (r = r.slice(0, 3) + r.slice(4, 6)),
                        6 != n.length ||
                            ("-" != n[0] && "+" != n[0]) ||
                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (t)
                                for (
                                    var e = 0, n = this.jCal[2], r = n.length;
                                    e < r;
                                    e++
                                ) {
                                    if (n[e][0] === t)
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            for (
                                var e = this.jCal[1], n = e.length, r = 0;
                                r < n;
                                r++
                            )
                                if (e[r][0] === t) return !0
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            if (t)
                                for (
                                    var e = 0, n = this.jCal[1], r = n.length;
                                    e < r;
                                    e++
                                ) {
                                    if (n[e][0] === t)
                        ...
                        value: function () {
                            for (var t, e, n, r = 0; ; ) {
                                ...
                                if (
                                    ...
                                    (this.last = e),
                                    !this.exDate ||
                                        ((n = this.exDate.compare(this.last)) <
                                            0 && this._nextExDay(),
                                        0 !== n))
                                )
                                    return this.last
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            return (
                                ...
                                this.ruleDates &&
                                    (e.ruleDates = this.ruleDates.map(t)),
                                this.exDates &&
                                    (e.exDates = this.exDates.map(t)),
