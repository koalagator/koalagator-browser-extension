...
!(function (t, e) {
	"object" == typeof exports && "undefined" != typeof module
		...
		: "function" == typeof define && define.amd
			? define(e)
			: ((t = "undefined" != typeof globalThis ? globalThis : t || self).ICAL =
					e());
})(this, function () {
	"use strict";
	function t(t, e, n) {
	...
	function e(t, e, r) {
		return (
			...
			(function (t, e) {
				...
				t,
				n() ? Reflect.construct(e, r || [], h(t).constructor) : e.apply(t, r)
			)
		);
	}
	function n() {
						...
						value: function (t) {
							...
							do {
								(e =
									...
									(i = 63 & a),
									(h[u++] =
										s.charAt(e) + s.charAt(n) + s.charAt(r) + s.charAt(i));
							} while (o < t.length);
							l = h.join("");
							var c = t.length % 3;
							...
							do {
								(e =
									((s =
										...
										((i = o.indexOf(t.charAt(u++))) << 6) |
										(a = o.indexOf(t.charAt(u++)))) >>
										16) &
									255),
									(n = (s >> 8) & 255),
									(r = 255 & s),
			...
			return o(
				...
				[
					...
					},
					{
						...
						value: function (e) {
							for (
								var n = 0, r = Object.create(null), i = 0;
								-1 !== (n = e.search(D));
		...
		return o(
			...
			[
				...
				},
				{
					...
					value: function (t) {
						var n = t || e.SUNDAY,
							r = (this.year << 12) + (this.month << 8) + (this.day << 3) + n;
				...
				},
				{
					...
					value: function () {
						...
						return e.daysInYearPassedMonth[t][this.month - 1] + this.day;
					}
				},
				{
					key: "startOfWeek",
				...
				},
				{
					...
					value: function (t) {
						var n = t || e.SUNDAY,
							r = this.clone();
						return (
							(r.day += (7 - this.dayOfWeek() + n - e.SUNDAY) % 7),
							(r.isDate = !0),
							(r.hour = 0),
							(r.minute = 0),
							(r.second = 0),
				...
				},
				{
					...
					value: function (t, e) {
						...
						return (0 === e && n === t) || this.nthWeekDay(t, e) === this.day;
					}
				},
				{
					key: "weekNumber",
					value: function (t) {
						var n,
							r = (this.year << 12) + (this.month << 8) + (this.day << 3) + t;
						...
						12 == i.month && i.day > 25
							? ((n = e.weekOneStarts(a + 1, t)),
								i.compare(n) < 0 ? (n = e.weekOneStarts(a, t)) : a++)
				...
				},
				{
					key: "utcOffset",
					value: function () {
						return this.zone == N.localTimezone || this.zone == N.utcTimezone
							? 0
				...
				},
				{
					key: "toString",
					value: function () {
						var t = this.year + "-" + W(this.month) + "-" + W(this.day);
						return (
							this.isDate ||
								((t +=
									"T" +
					...
					value: function (t, n, r, i, a) {
						...
						if (
							(m.isDate ||
								...
								(m.second = u % 60),
								(s = F(u / 60)),
								m.second < 0 && ((m.second += 60), s--),
								(l = m.minute + r + s),
								(m.minute = l % 60),
								(o = F(l / 60)),
								m.minute < 0 && ((m.minute += 60), o--),
								(h = m.hour + n + o),
								(m.hour = h % 24),
								(d = F(h / 24)),
								m.hour < 0 && ((m.hour += 24), d--)),
							m.month > 12
								? (y = F((m.month - 1) / 12))
								: m.month < 1 && (y = F(m.month / 12) - 1),
							(m.year += y),
							(m.month -= 12 * y),
							(c = m.day + t + d) > 0)
						)
							for (; !(c <= (f = e.daysInMonth(m.month, m.year))); )
								m.month++, m.month > 12 && (m.year++, (m.month = 1)), (c -= f);
						else
							for (; c <= 0; )
								1 == m.month ? (m.year--, (m.month = 12)) : m.month--,
			...
			[
				{
					...
					value: function (t, n) {
						...
						return (
							t < 1 ||
								t > 12 ||
								((r = [0, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][t]),
					...
					value: function (t, n) {
						...
						for (var o = 11; o >= 0; o--)
							if (i > e.daysInYearPassedMonth[s][o]) {
								(a.month = o + 1), (a.day = i - e.daysInYearPassedMonth[s][o]);
								break;
							}
				...
				},
				{
					...
					value: function (t, n) {
						if (t.length < 19)
							throw new Error('invalid date-time value: "' + t + '"');
						var r, i;
						t[19] && "Z" === t[19]
							? (r = N.utcTimezone)
							: n &&
								((i = n.getParameter("tzid")),
								n.parent &&
									("standard" === n.parent.name || "daylight" === n.parent.name
										? (r = N.localTimezone)
				...
				},
				{
					key: "weekOneStarts",
					value: function (t, n) {
						var r = e.fromData({ year: t, month: 1, day: 1, isDate: !0 }),
							i = r.dayOfWeek(),
	...
	var C = (function (t) {
		function n() {
			...
			for (var r = arguments.length, i = new Array(r), s = 0; s < r; s++)
				i[s] = arguments[s];
			return u((t = e(this, n, [].concat(i))), "name", t.constructor.name), t;
		}
		return l(n, t), o(n);
	})(f(Error));
	(E.ParserError = C),
		(E._handleContentLine = function (t, e) {
			...
			if ((-1 !== l && -1 !== u && l > u && (l = -1), -1 !== l)) {
				...
				if (
					...
					var c = [a.toLowerCase(), [], []];
					return (
						1 === e.stack.length ? e.component.push(c) : e.component[2].push(c),
						e.stack.push(e.component),
						(e.component = c),
						void (
							e.designSet || (e.designSet = It.getDesignSet(e.component[0]))
						)
					);
				}
			...
			e.designSet.propertyGroups && -1 !== i.indexOf(".")
				...
				y in e.designSet.property &&
					("multiValue" in (f = e.designSet.property[y]) && (p = f.multiValue),
					"structuredValue" in f && (v = f.structuredValue),
					a && "detectType" in f && (o = f.detectType(a))),
				o ||
					(o =
						"value" in h
							? h.value.toLowerCase()
				...
				p && v
					? (m = [
							...
							h,
							o,
							(a = E._parseMultiValue(a, v, o, [], p, e.designSet, v))
						])
					: p
						? ((m = [y, h, o]),
							E._parseMultiValue(a, p, o, m, null, e.designSet, !1))
						: (m = v
								? [
										y,
										h,
										o,
										(a = E._parseMultiValue(a, v, o, [], null, e.designSet, v))
									]
								: [y, h, o, (a = E._parseValue(a, o, e.designSet, !1))]),
				"vcard" !== e.component[0] ||
		...
		(E._parseParameters = function (t, e, n) {
			for (
				var r, i, a, s, o, u, l = e, h = 0, c = {}, f = -1;
				!1 !== h && -1 !== (h = t.indexOf("=", h + 1));
				...
				if (
					...
					(o = !1),
					(s =
						(i = r.toLowerCase()) in n.param && n.param[i].valueType
							? n.param[i].valueType
							: "text"),
					i in n.param &&
						((o = n.param[i].multiValue),
						n.param[i].multiValueSeparateDQuote &&
							(u = E._rfc6868Escape('"' + o + '"'))),
					'"' === t[h + 1])
				) {
					if (((f = h + 2), (h = t.indexOf('"', f)), o && -1 != h))
						for (var d = !0; d; )
							t[h + 1] == o && '"' == t[h + 2]
								? (h = t.indexOf('"', h + 3))
								: (d = !1);
			...
			return o(
				...
				[
					...
					},
					{
						key: "utcOffset",
						value: function (t) {
							if (this == e.utcTimezone || this == e.localTimezone) return 0;
							if ((this._ensureCoverage(t.year), !this.changes.length))
								return 0;
							for (
								var n = {
										year: t.year,
								...
								if (
									(s.utcOffset < s.prevUtcOffset
										? e.adjust_change(s, 0, 0, 0, s.utcOffset)
										: e.adjust_change(s, 0, 0, 0, s.prevUtcOffset),
									e._compare_change_fn(n, s) >= 0 ? (i = r) : (a = -1),
									-1 == a && -1 != i)
								)
									break;
								if ((r += a) < 0) return 0;
							...
							if (o.utcOffset - o.prevUtcOffset < 0 && i > 0) {
								var u = H(o, !0);
								if (
									(e.adjust_change(u, 0, 0, 0, u.prevUtcOffset),
									e._compare_change_fn(n, u) < 0)
								) {
									var l = this.changes[i - 1],
										h = !1;
									o.is_daylight != h && l.is_daylight == h && (o = l);
								}
							}
							return o.utcOffset;
						}
					...
					},
					{
						...
						value: function (t) {
							...
							var r = t;
							if (
								(r < e._minimumExpansionYear && (r = e._minimumExpansionYear),
								(r += e.EXTRA_COVERAGE),
								!this.changes.length || this.expandedUntilYear < t)
							) {
								for (
									var i = this.component.getAllSubcomponents(),
										a = i.length,
										s = 0;
									s < a;
									s++
					...
					},
					{
						...
						value: function (t, n, r) {
							if (
								...
								return null;
							var i,
								a = t.getFirstProperty("dtstart").getFirstValue();
							function s(t) {
										...
										((i = o()).year = h.year),
											...
											h.isDate
												? ((i.hour = a.hour),
													(i.minute = a.minute),
													(i.second = a.second),
													a.zone != e.utcTimezone &&
														e.adjust_change(i, 0, 0, 0, -i.prevUtcOffset))
												: ((i.hour = h.hour),
													(i.minute = h.minute),
													(i.second = h.second),
													h.zone != e.utcTimezone &&
														e.adjust_change(i, 0, 0, 0, -i.prevUtcOffset)),
											r.push(i);
									}
								} catch (t) {
								...
								if (c) {
									(c = c.getFirstValue()),
										...
										c.until &&
											...
											(c.until.adjust(0, 0, 0, i.prevUtcOffset),
											(c.until.zone = e.localTimezone));
									for (
										var f, d = c.iterator(a);
										(f = d.next()) && ((i = o()), !(f.year > n) && f);
				...
				[
					...
					},
					{
						...
						get: function () {
							return (
								t(e, this, I)._ ||
									(I._ = t(e, this, e.fromData({ tzid: "UTC" }))),
								t(e, this, I)._
							);
						}
					},
					{
						...
						get: function () {
							return (
								t(e, this, B)._ ||
									(B._ = t(e, this, e.fromData({ tzid: "floating" }))),
								t(e, this, B)._
							);
						}
					},
	...
	var M = null,
		z = {
			...
			register: function (t, e) {
				if (
					(null === M && this.reset(), "string" == typeof t && e instanceof N)
				) {
					var n = [e, t];
					(t = n[0]), (e = n[1]);
				}
				if (
					(e ||
						(t instanceof N
							? (e = t.tzid)
							: "vtimezone" === t.name && (e = (t = new N(t)).tzid)),
					!e)
				)
			...
			return o(
				...
				[
					...
					},
					{
						key: "_normalize",
						value: function () {
							for (var t = this.toSeconds(), e = this.factor; t < -43200; )
								t += 97200;
							for (; t > 50400; ) t -= 97200;
					...
					},
					{
						key: "toICALString",
						value: function () {
							return It.icalendar.value["utc-offset"].toICAL(this.toString());
						}
					},
					{
						key: "toString",
					...
					[
						{
							key: "clone",
							value: function () {
								return new n(this._time, this.zone, this.icaltype);
							}
						},
						{
							key: "_normalize",
						...
						},
						{
							key: "utcOffset",
							value: function () {
								return this.zone instanceof J
									? this.zone.toSeconds()
									: b.prototype.utcOffset.apply(this, arguments);
							}
						},
						{
							key: "toICALString",
							value: function () {
								return It.vcard.value[this.icaltype].toICAL(this.toString());
							}
						},
						{
							key: "toString",
							value: function () {
								...
								else if (this.zone instanceof J) t = this.zone.toString();
								else if (this.zone === N.localTimezone) t = "";
								else if (this.zone instanceof N) {
									t = J.fromSeconds(this.zone.utcOffset(this)).toString();
								} else t = "";
					...
					[
						{
							...
							value: function (t, e) {
								...
								var i = t.split("T"),
									a = i[0],
									s = i[1],
									o = s ? It.vcard.value.time._splitZone(s) : [],
									u = o[0],
									l = o[1],
									h = a ? a.length : 0,
									c = l ? l.length : 0,
		...
		G = (function () {
			function t(e) {
				a(this, t),
					...
					u(this, "dtstart", null),
					u(this, "last", null),
					u(this, "occurrence_number", 0),
					u(this, "by_indices", null),
			...
			return o(t, [
					...
					value: function (t) {
						...
						if (
							(t.by_data
								...
								: (this.by_data = H(this.rule.parts, !0)),
							t.occurrence_number &&
								(this.occurrence_number = t.occurrence_number),
							(this.days = t.days || []),
							t.last && (this.last = U(t.last, b)),
				...
				},
				{
					...
					value: function () {
						...
						if (
							...
							if ("BYDAY" in e) {
								var n = d(this.ruleDayOfWeek(e.BYDAY[0], this.rule.wkst), 2)[1],
									r = n - this.last.dayOfWeek(this.rule.wkst);
								((this.last.dayOfWeek(this.rule.wkst) < n && r >= 0) ||
									r < 0) &&
									(this.last.day += r);
							} else {
								var i = rt.numericDayToIcalDay(this.dtstart.dayOfWeek());
								e.BYDAY = [i];
							}
						if ("YEARLY" == this.rule.freq) {
							for (
								var a = this.rule.until ? this.rule.until.year : 2e4;
								this.last.year <= a &&
						...
						if ("MONTHLY" == this.rule.freq)
							if (this.has_by_data("BYDAY")) {
								var s,
									o = null,
									u = this.last.clone(),
									l = b.daysInMonth(this.last.month, this.last.year),
								...
								if (_.length)
									(this.last.day = _[0]), (this.by_data.BYMONTHDAY = _);
								else if (
									!this.next_month() &&
									!this.next_month() &&
									!this.next_month()
				...
				},
				{
					...
					value: function (t, e, n) {
						for (
							var r, i = b.daysInMonth(e, t), a = [], s = 0, o = n.length;
							s < o;
							s++
						) {
								...
								if (y >= n) {
									...
									for (var m = 0; m < o; m++) {
										var p = this.ruleDayOfWeek(a[m]),
											v = p[0],
											_ = p[1];
										if (((this.last.day = h), this.last.isNthWeekDay(_, v))) {
											u = 1;
											break;
										}
									}
				...
				},
				{
					...
					value: function () {
						...
						if (this.has_by_data("BYDAY") && this.has_by_data("BYMONTHDAY"))
							...
							var e,
								n = b.daysInMonth(this.last.month, this.last.year),
								r = 0,
								i = 0;
							if (this.has_by_data("BYSETPOS")) {
								for (var a = this.last.day, s = 1; s <= n; s++)
									(this.last.day = s),
										this.is_day_in_byday(this.last) && (i++, s <= a && r++);
								this.last.day = a;
							}
							...
							if (
								...
								return 0;
							var o = b.daysInMonth(this.last.month, this.last.year),
								u = this.by_data.BYMONTHDAY[this.by_indices.BYMONTHDAY];
							u < 0 && (u = o + u + 1),
								u > o
							...
							this.increment_month();
							var l = b.daysInMonth(this.last.month, this.last.year);
				...
				},
				{
					...
					value: function (t, e) {
						...
						return n
							? [parseInt(n[1] || 0, 10), (t = rt.icalDayToNumericDay(n[2], e))]
							: [0, 0];
					}
				},
				{
				...
				},
				{
					...
					value: function (t) {
						for (var e = 0; e < t; e++) {
							var n = b.daysInMonth(this.last.month, this.last.year);
							this.last.day++,
								this.last.day > n &&
									((this.last.day -= n), this.increment_month());
						}
					}
				},
				{
					...
					value: function () {
						if (((this.last.day = 1), this.has_by_data("BYMONTH")))
							this.by_indices.BYMONTH++,
								...
								(this.last.month =
									this.by_data.BYMONTH[this.by_indices.BYMONTH]);
						else {
							"MONTHLY" == this.rule.freq
				...
				},
				{
					...
					value: function (t, e, n, r) {
						...
						(this.last[e] %= n), 0 != i && this["increment_" + r](i);
					}
				},
				{
					key: "has_by_data",
				...
				},
				{
					...
					value: function (t) {
						...
						for (
							var n = {},
								r = 0,
								i = ["BYDAY", "BYWEEKNO", "BYMONTHDAY", "BYMONTH", "BYYEARDAY"];
							r < i.length;
							r++
						) {
							var a = i[r];
						...
						if ("BYMONTH" in n && "BYWEEKNO" in n) {
							...
							for (var f = 0; f < this.by_data.BYWEEKNO.length && s; f++) {
								this.by_data.BYWEEKNO[f] < 52 ? (s &= o[f]) : (s = 0);
							}
						...
						if (0 == d) {
							...
							(y.year = this.last.year), this.days.push(y.dayOfYear());
							...
							try {
								for (T.s(); !(D = T.n()).done; ) {
									...
									if (Y < 0) Y = Y + b.daysInMonth(k.month, t) + 1;
									(k.day = Y),
										(k.year = t),
										(k.isDate = !0),
						...
						} else if (2 == d && "BYMONTHDAY" in n && "BYMONTH" in n) {
							var O,
						...
						else if (2 == d && "BYWEEKNO" in n && "BYMONTHDAY" in n);
							...
							try {
								for (I.s(); !(N = I.n()).done; ) {
									var B = N.value,
										M = b.daysInMonth(B, t);
									(e.year = t), (e.month = B), (e.day = 1), (e.isDate = !0);
									var z = e.dayOfWeek(),
										L = e.dayOfYear() - 1;
									e.day = M;
									var P = e.dayOfWeek();
									if (this.has_by_data("BYSETPOS")) {
										for (var U = [], j = 1; j <= M; j++)
											(e.day = j), this.is_day_in_byday(e) && U.push(j);
										for (var V = 0; V < U.length; V++)
											(this.check_set_position(V + 1) ||
												this.check_set_position(V - U.length)) &&
										...
										try {
											for (R.s(); !(H = R.n()).done; ) {
												var W = H.value,
													...
													G = M - ((P + 7 - q) % 7);
												if (0 == K)
													for (var X = Z; X <= M; X += 7) this.days.push(L + X);
												else
													K > 0
														? (J = Z + 7 * (K - 1)) <= M &&
															this.days.push(L + J)
						...
						} else if (2 == d && "BYDAY" in n && "BYMONTHDAY" in n) {
							var Q,
							...
							try {
								for ($.s(); !(Q = $.n()).done; ) {
									...
									this.by_data.BYMONTHDAY.indexOf(et.day) >= 0 &&
										this.days.push(tt);
								}
							} catch (t) {
								$.e(t);
							...
							try {
								for (rt.s(); !(nt = rt.n()).done; ) {
									...
									this.by_data.BYMONTH.indexOf(at.month) >= 0 &&
										this.by_data.BYMONTHDAY.indexOf(at.day) >= 0 &&
										this.days.push(it);
								}
							} catch (t) {
								rt.e(t);
							...
							try {
								for (ot.s(); !(st = ot.n()).done; ) {
									var ut = st.value,
										lt = b.fromDayOfYear(ut, t).weekNumber(this.rule.wkst);
									this.by_data.BYWEEKNO.indexOf(lt) && this.days.push(ut);
								}
							} catch (t) {
								ot.e(t);
							} finally {
							...
							(3 == d &&
								...
								(this.days =
									1 == d && "BYYEARDAY" in n
										? this.days.concat(this.by_data.BYYEARDAY)
										: []);
						var ht = b.isLeapYear(t) ? 366 : 365;
						return (
							this.days.sort(function (t, e) {
								return t < 0 && (t += ht + 1), e < 0 && (e += ht + 1), t - e;
							}),
							0
						);
					}
				},
				{
					...
					value: function (t) {
						var e = [],
							n = this.last.clone();
						(n.year = t), (n.month = 1), (n.day = 1), (n.isDate = !0);
						var r = n.dayOfWeek();
						...
						try {
							for (o.s(); !(i = o.n()).done; ) {
								var u = i.value,
									...
									c = l[1];
								if (0 == h)
									for (var f = ((c + 7 - r) % 7) + 1; f <= s; f += 7) e.push(f);
								else if (h > 0) {
									var d = void 0;
									(d = c >= r ? c - r + 1 : c - r + 8), e.push(d + 7 * (h - 1));
								} else {
									var y = void 0;
									(h = -h),
										(y = c <= a ? s - a + c : s - a + c - 7),
							...
							try {
								for (n.s(); !(e = n.n()).done; ) {
									var r = e.value,
										...
										s = i[1],
										o = t.dayOfWeek();
									if ((0 == a && s == o) || t.nthWeekDay(s, a) == t.day)
										return 1;
								}
							} catch (t) {
								n.e(t);
				...
				},
				{
					...
					value: function (t) {
						for (var e = 0; e < t.length; e++)
							for (var n = 0; n < e; n++) {
								if (
									this.ruleDayOfWeek(t[n], this.rule.wkst)[1] >
		...
		rt = (function () {
			function t(e) {
				a(this, t),
					u(this, "parts", null),
					u(this, "interval", 1),
					u(this, "wkst", b.MONDAY),
					u(this, "until", null),
					u(this, "count", null),
					u(this, "freq", null),
					u(this, "icalclass", "icalrecur"),
			...
			return o(
				...
				[
					...
					},
					{
						...
						value: function (t, e) {
							var n = t.toUpperCase();
							n in this.parts ? this.parts[n].push(e) : (this.parts[n] = [e]);
						}
					},
					{
						key: "setComponent",
					...
					},
					{
						...
						value: function (e) {
							...
							this.interval &&
								...
								at.INTERVAL(this.interval, this),
								this.wkst &&
									"number" != typeof this.wkst &&
									(this.wkst = t.icalDayToNumericDay(this.wkst)),
								!this.until ||
					...
					},
					{
						...
						value: function () {
							...
							(e.freq = this.freq),
								...
								this.interval > 1 && (e.interval = this.interval);
							for (
					...
					},
					{
						...
						value: function () {
							...
							return (
								this.until && (e += ";UNTIL=" + this.until.toICALString()),
								"wkst" in this &&
									this.wkst !== b.DEFAULT_WEEK_START &&
									(e += ";WKST=" + t.numericDayToIcalDay(this.wkst)),
								e
	...
	function it(t, e, n, r) {
		var i = r;
		if (("+" === r[0] && (i = r.slice(1)), (i = P(i)), void 0 !== e && r < e))
	...
	var at = {
			FREQ: function (t, e, n) {
				if (-1 === nt.indexOf(t))
					throw new Error(
						'invalid frequency "' + t + '" expected: "' + nt.join(", ") + '"'
					);
				e.freq = t;
			},
			...
			WKST: function (t, e, n) {
				if (!Q.test(t)) throw new Error('invalid WKST value "' + t + '"');
		...
		ot = (function () {
			function t(e) {
				if (
					...
					u(this, "icalclass", "icalperiod"),
					u(this, "icaltype", "period"),
					(this.wrappedJSObject = this),
					e && "start" in e)
				) {
				...
				[
					{
						...
						value: function (e, n) {
							...
							if (2 !== r.length)
								throw new Error(
									'Invalid string value: "' + e + '" must contain a "/" char.'
								);
					...
					},
					{
						...
						value: function (e, n, r) {
							function i(t, e) {
								return r ? b.fromString(t, e) : b.fromDateTimeString(t, e);
							}
							return Y.isValueString(e[1])
								...
								: t.fromData({ start: i(e[0], n), end: i(e[1], n) });
						}
					}
				]
			);
	...
	var ct = { defaultType: "text" },
		...
		dt = { defaultType: "text", structuredValue: ";" },
		yt = { defaultType: "integer" },
		mt = { defaultType: "date-time", allowedTypes: ["date-time", "date"] },
		pt = { defaultType: "date-time" },
		vt = { defaultType: "uri" },
		_t = { defaultType: "utc-offset" },
	...
	var Yt = { categories: ft, url: vt, version: ct, uid: ct },
		...
		bt = K(kt, {
			...
			date: {
				decorate: function (t, e) {
					return It.strict ? b.fromDateString(t, e) : b.fromString(t, e);
				},
				undecorate: function (t) {
					return t.toString();
				},
			...
			"date-time": {
				...
				decorate: function (t, e) {
					return It.strict ? b.fromDateTimeString(t, e) : b.fromString(t, e);
				},
				undecorate: function (t) {
					return t.toString();
				}
			...
			period: {
				fromICAL: function (t) {
					...
					return (
						...
						Y.isValueString(e[1]) || (e[1] = bt["date-time"].fromICAL(e[1])),
						e
					);
				},
				toICAL: function (t) {
					return (
						(t = t.slice()),
						It.strict || 10 != t[0].length
							? (t[0] = bt["date-time"].toICAL(t[0]))
							: (t[0] = bt.date.toICAL(t[0])),
						Y.isValueString(t[1]) ||
							(It.strict || 10 != t[1].length
			...
			recur: {
				...
				toICAL: function (t) {
					for (var e = "", n = 0, r = Object.entries(t); n < r.length; n++) {
						...
						"until" == a
							? (s =
									s.length > 10 ? bt["date-time"].toICAL(s) : bt.date.toICAL(s))
							: "wkst" == a
								? "number" == typeof s && (s = rt.numericDayToIcalDay(s))
			...
			time: {
				fromICAL: function (t) {
					...
					var e = t.slice(0, 2) + ":" + t.slice(2, 4) + ":" + t.slice(4, 6);
					return "Z" === t[6] && (e += "Z"), e;
				},
				toICAL: function (t) {
		...
		At = K(kt, {
				...
				_splitZone: function (t, e) {
					...
					return (
						"Z" == t[i]
							...
							: t.length > 6 && ("-" == s || "+" == s)
								? ((n = t.slice(a)), (r = t.slice(0, Math.max(0, a))))
								: ((n = ""), (r = t)),
						[n, r]
					);
				}
			...
			"date-and-or-time": {
				...
				toICAL: function (t) {
					var e = t.split("T");
					return (
						At.date.toICAL(e[0]) + (e[1] ? "T" + At.time.toICAL(e[1]) : "")
					);
				}
			},
		...
		It = {
			...
			getDesignSet: function (t) {
				return t && t in It.components ? It.components[t] : It.defaultSet;
			}
		},
		Bt = "\r\n",
		Mt = "unknown",
	...
	(Lt.component = function (t, e) {
		...
		(Lt.property = function (t, e, n) {
						...
						a && Array.isArray(r)
							? ((r = r.map(function (t) {
									return (
										...
										(t = Lt.paramPropertyValue(t, i.multiValueSeparateDQuote))
									);
								})),
								(r = Lt.multiValue(r, a, "unknown", null, e)))
							: ((r = Lt._rfc6868Unescape(r)), (r = Lt.paramPropertyValue(r))),
							(s += ";" + n.toUpperCase() + "=" + r);
					},
					l = 0,
					h = Object.entries(a);
			...
			return (
				i in e.property
					? ("multiValue" in (c = e.property[i]) && (y = c.multiValue),
						"structuredValue" in c &&
							Array.isArray(t[3]) &&
							(m = c.structuredValue),
						"defaultType" in c
							? f === c.defaultType && (p = !0)
							: f === Mt && (p = !0))
					: f === Mt && (p = !0),
				p || (s += ";VALUE=" + f.toUpperCase()),
				(s += ":"),
				(s +=
					y && m
						? Lt.multiValue(t[3], m, f, y, e, m)
						: y
							? Lt.multiValue(t.slice(3), y, f, null, e, !1)
							: m
	...
	var Pt = (function () {
			...
			return o(
				...
				[
					...
					},
					{
						...
						set: function (t) {
							var e =
								!this._parent || (t && t._designSet != this._parent._designSet);
							(this._parent = t),
					...
					},
					{
						key: "_designSet",
						get: function () {
							return this.parent ? this.parent._designSet : It.defaultSet;
						}
					},
					{
						key: "_updateType",
							...
							this.type in t.value &&
								...
								this.name in t.property &&
									...
									(this.isStructuredValue =
										"structuredValue" in t.property[this.name])));
						}
					},
					{
						key: "_hydrateValue",
					...
					},
					{
						...
						value: function () {
							...
							if (t < 1) return [];
							for (var e = 0, n = []; e < t; e++) n[e] = this._hydrateValue(e);
							return n;
						}
					},
					{
					...
					},
					{
						...
						value: function (t) {
							...
							if (
								...
								for (; n < e; n++) this._setDecoratedValue(t[n], n);
		...
		Ut = (function () {
			function t(e, n) {
				a(this, t),
					u(this, "_hydratedPropertyCount", 0),
					u(this, "_hydratedComponentCount", 0),
					u(this, "_timezoneCache", null),
					u(this, "_components", null),
					u(this, "_properties", null),
					"string" == typeof e && (e = [e, [], []]),
					(this.jCal = e),
					(this.parent = n || null),
					this.parent ||
			...
			return o(
				...
				[
					...
					},
					{
						...
						value: function (t) {
							if (t)
								for (var e = 0, n = this.jCal[2], r = n.length; e < r; e++) {
									if (n[e][0] === t) return this._hydrateComponent(e);
								}
						...
						value: function (t) {
							...
							if (t) {
								for (var r = this.jCal[2], i = []; n < e; n++)
									t === r[n][0] && i.push(this._hydrateComponent(n));
								return i;
							}
					...
					},
					{
						key: "hasProperty",
						value: function (t) {
							for (var e = this.jCal[1], n = e.length, r = 0; r < n; r++)
								if (e[r][0] === t) return !0;
							return !1;
						}
					},
					{
						...
						value: function (t) {
							if (t)
								for (var e = 0, n = this.jCal[1], r = n.length; e < r; e++) {
									if (n[e][0] === t) return this._hydrateProperty(e);
								}
						...
						value: function (t) {
							...
							if (t) {
								for (var r = this.jCal[1], i = []; n < e; n++)
									t === r[n][0] && i.push(this._hydrateProperty(n));
								return i;
							}
					...
					},
					{
						...
						value: function (t, e, n) {
							...
							if ("string" == typeof n) {
								for (; r < a; r++)
									if (i[r][0] === n)
										return this._removeObjectByIndex(t, s, r), !0;
							} else if (s)
								for (; r < a; r++)
									if (s[r] && s[r] === n)
										return this._removeObjectByIndex(t, s, r), !0;
					...
					},
					{
						...
						value: function (t, e, n) {
							for (
								var r = this[e], i = this.jCal[t], a = i.length - 1;
								a >= 0;
								a--
							)
								(n && i[a][0] !== n) || this._removeObjectByIndex(t, r, a);
						}
					},
					{
						key: "addSubcomponent",
					...
					},
					{
						...
						value: function (t, e) {
							...
							return (
								n ? n.setValue(e) : (n = this.addPropertyWithValue(t, e)), n
							);
						}
					},
					{
					...
					},
					{
						...
						value: function (t) {
							...
							try {
								for (n.s(); !(e = n.n()).done; ) {
									var r = e.value;
									if (r.getFirstProperty("tzid").getFirstValue() === t) {
										var i = new N({ component: r, tzid: t });
		...
		jt = (function () {
			return o(
				function t(e) {
					a(this, t),
						u(this, "complete", !1),
						u(this, "ruleIterators", null),
						u(this, "ruleDates", null),
						u(this, "exDates", null),
						u(this, "ruleDateInc", 0),
						u(this, "exDateInc", 0),
						u(this, "exDate", null),
						u(this, "ruleDate", null),
						u(this, "dtstart", null),
						u(this, "last", null),
						(this.ruleDates = []),
						(this.exDates = []),
				...
				[
					{
						...
						value: function (t) {
							...
							if (((this.dtstart = e), t.component)) this._init(t.component);
								...
								if (((this.last = U(t.last, b) || e.clone()), !t.ruleIterators))
								...
								(this.ruleIterators = t.ruleIterators.map(function (t) {
									...
									t.ruleDates &&
										((this.ruleDates = t.ruleDates.map(function (t) {
											return U(t, b);
										})),
										(this.ruleDate = this.ruleDates[this.ruleDateInc])),
									t.exDates &&
										((this.exDates = t.exDates.map(function (t) {
											return U(t, b);
										})),
						...
						value: function () {
							for (var t, e, n, r = 0; ; ) {
								...
								if (
									...
									(this.last = e),
									!this.exDate ||
										((n = this.exDate.compare(this.last)) < 0 &&
											this._nextExDay(),
										0 !== n))
								)
									return this.last;
					...
					},
					{
						...
						value: function (t, e) {
							for (
								var n = [], r = t.getAllProperties(e), i = 0, a = r.length;
								i < a;
								i++
							) {
								var s,
					...
					},
					{
						...
						value: function (t) {
							if (
								...
								return (
									(this.ruleDate = this.last.clone()), void (this.complete = !0)
								);
							if (
								(t.hasProperty("rdate") &&
								...
								for (
									var e, n = t.getAllProperties("rrule"), r = 0, i = n.length;
									r < i;
									r++
								)
									(e = n[r].getFirstValue().iterator(this.dtstart)),
										this.ruleIterators.push(e),
										e.next();
							t.hasProperty("exdate") &&
								((this.exDates = this._extractDates(t, "exdate")),
								(this.exDateInc = V(this.exDates, this.last, function (t, e) {
									return t.compare(e);
								})),
								(this.exDate = this.exDates[this.exDateInc]));
						}
		...
		Vt = (function () {
			function t(e, n) {
				a(this, t),
					u(this, "exceptions", null),
					u(this, "strictExceptions", !1),
					e instanceof Ut || ((n = e), (e = null)),
					(this.component = e || new Ut("vevent")),
					(this._rangeExceptionCache = Object.create(null)),
					(this.exceptions = Object.create(null)),
					(this.rangeExceptions = []),
					n &&
						n.strictExceptions &&
						(this.strictExceptions = n.strictExceptions),
					n && n.exceptions
						? n.exceptions.forEach(this.relateException, this)
			...
			return o(t, [
				...
				},
				{
					...
					value: function () {
						return (
							!!this.component.hasProperty("recurrence-id") &&
							this.component
				...
				},
				{
					...
					value: function () {
						for (
							var t = this.component.getAllProperties("rrule"),
								e = 0,
								n = t.length,
				...
				},
				{
					...
					value: function (t, e) {
						...
						n || ((n = new Pt(t)), this.component.addProperty(n)),
							e.zone === N.localTimezone || e.zone === N.utcTimezone
	...
	var Rt = (function () {
			return o(
				function t(e) {
					a(this, t),
						u(this, "parseEvent", !0),
						u(this, "parseTimezone", !0),
						u(this, "oncomplete", function () {}),
				...
				[
					{
						...
						value: function (t) {
							...
							for (
								var e, n = t.getAllSubcomponents(), r = 0, i = n.length;
								r < i;
								r++
							)
								switch ((e = n[r]).name) {
									case "vtimezone":
										if (this.parseTimezone) {
											...
											a && this.ontimezone(new N({ tzid: a, component: e }));
										}
										break;
									case "vevent":
										this.parseEvent && this.onevent(new Vt(e));
										break;
									default:
										continue;
								}
